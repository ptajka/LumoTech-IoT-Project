...
def request_current_weather(city_id):
    ...
    # weather_descriptions_array = ['Clear', 'Clouds', 'Rain', 'Snow', 'Atmosphere', 'Drizzle', 'Thunderstorm'] # номер погоды от 0 до 7 (все 8 вариантов)
    try:
...
print(temperature, weather_num)

send_weather(f'{temperature},{weather_num}')
for i in range(20):
    time.sleep(0.05)
    data = arduino.readline()
    if data!="b\'\'":
